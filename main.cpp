...
{
	/*******************************************************************************/
	//Ray's Kinect Calibration Parameters
	float fx_rgb = 5.1730470631289802e+02;
	float fy_rgb = 5.1725899076394558e+02;
	float cx_rgb = 3.1915184777028014e+02;
	float cy_rgb = 2.5050530197700081e+02;
	float k1_rgb =  2.4994893906144616e-01;
	float k2_rgb = -1.1407005754722184e+00;
	float p1_rgb = -1.5919992714974215e-03;
	float p2_rgb = -2.2615700525067152e-03;
	float k3_rgb = 2.2819884460482256e+00;

	float fx_d =  5.8866668740560942e+02;
	float fy_d = 5.8716621507858315e+02;
	float cx_d = 3.2278684349624007e+02;
	float cy_d = 2.2547046229002288e+02;
	float k1_d =  -2.1061534214280081e-01;
	float k2_d = 1.0644229083410282e+00;
	float p1_d = 1.2156843086955538e-03;
	float p2_d = -8.0863015107916628e-04;
	float k3_d =  -1.8152669581811400e+00 ;

	Mat R = (Mat_<float>(3, 3) <<
			 9.9999694015833185e-01, 2.2592053479413110e-03,
			 -1.0078021479537535e-03, -2.2694551257963738e-03,
			 9.9994450232779297e-01, -1.0287946240841334e-02,
			 9.8450363411385308e-04, 1.0290201923105211e-02,
			 9.9994656982109609e-01);

	Mat T = (Mat_<float>(3, 1) <<
			2.4889323542400626e-02, 1.3244319693397587e-03,
			2.9373718565205557e-03);
	/*******************************************************************************/
